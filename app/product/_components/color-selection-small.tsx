...
const ColorSelectionSmall = ({
  ...
  return (
    <>
      <div
        data-aos="flip-up"
        className="flex flex-col items-center md:hidden pb-1 mt-5"
      >
        ...
        <div className="grid grid-cols-5 md:grid-cols-5 grid-rows-2 md:grid-rows-2 gap-2 p-2 w-fit h-fit bg-slate-200 rounded-sm relative mt-5 place-content-center">
          {data.map((product) => (
            <div
              key={product.id}
              style={{
