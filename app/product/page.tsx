...
const BuyerSatisfaction = dynamic(
  () => import("./_components/buyer-satisfaction"),
  {}
);
const ColorSelectionSectionLarge = dynamic(
  () => import("./_components/color-selection-large"),
  {}
);
const ColorSelectionSmall = dynamic(
  () => import("./_components/color-selection-small"),
  {}
);
const Page = () => {
    ...
    return [
      {
        ...
        src: getImageURL(
          500,
          900,
          "blue-spark/fancy-colored-diamonds/yellow-fancy"
        ),
      ...
      },
      {
        ...
        src: getImageURL(
          500,
          900,
          "blue-spark/fancy-colored-diamonds/DarkGrey"
        ),
      ...
      },
      {
        ...
        src: getImageURL(
          500,
          900,
          "blue-spark/fancy-colored-diamonds/Pink-Fancy"
        ),
      ...
      },
      {
        ...
        src: getImageURL(
          500,
          900,
          "blue-spark/fancy-colored-diamonds/Blue-Fancy"
        ),
      ...
      },
      {
        ...
        src: getImageURL(
          500,
          900,
          "blue-spark/fancy-colored-diamonds/Purple-Fancy"
        ),
      ...
      },
      {
        ...
        src: getImageURL(
          500,
          900,
          "blue-spark/fancy-colored-diamonds/violet-fancy"
        ),
      ...
      },
      {
        ...
        src: getImageURL(
          500,
          900,
          "blue-spark/fancy-colored-diamonds/Red-Fancy"
        ),
