            ...
            >
                ...
                <div className="relative flex self-center flex-1 p-8 ml-0 bg-white border rounded shadow lg:items-center lg:-ml-12">
                    <div>
                        ...
                        <div className="flex">
                            <span className="inline-block mr-5 text-gray-700 hover:text-[#1877F2]">
                                <svg
                                    width="16"
                                    height="16"
                                    fill="currentColor"
                            ...
                            <span className="inline-block mr-5 text-gray-700 hover:text-[#1D9BF0">
                                <svg
                                    width="16"
                                    height="16"
                                    fill="currentColor"
                            ...
                            <span className="inline-block mr-5 text-gray-700 hover:text-[#E4405F]">
                                <svg
                                    width="16"
                                    height="16"
                                    fill="currentColor"
