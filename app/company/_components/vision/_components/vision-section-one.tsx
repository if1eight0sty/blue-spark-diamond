      ...
      <div className="grid grid-cols-1 gap-x-4 gap-y-6 lg:gap-x-8 lg:gap-y-8 md:grid-cols-2 lg:grid-cols-3">
        <div className="w-full px-8 mb-5 text-center transition-all bg-white rounded shadow hover:shadow-lg text-[#585858] relative">
          <div className="absolute -left-5 -top-5 flex items-center gap-x-3   ">
            <div className="p-4 bg-blue-400 rounded-full">
              <MdPolicy className="text-[38px] text-white" />
            </div>
          ...
          <p className="text-base text-gray-500 mt-16 mb-4">
            ...
            foremost supplier of ethically sourced diamonds. We aim to lead the
            industry in providing premium, certified, and high-quality diamonds,
            all while maintaining a strong commitment to ethical sourcing.
          </p>
        </div>
        <div className="w-full p-8 mb-5 text-center transition-all bg-white rounded shadow  hover:shadow-lg text-[#585858]">
          <div className="inline-block p-4 mb-6 -mt-16 bg-blue-400 rounded-full">
            <VscWorkspaceTrusted className="text-[38px] text-white" />
          </div>
        ...
        <div className="w-full p-8 mb-5 text-center transition-all bg-white rounded shadow hover:shadow-lg text-[#585858]">
          <div className="inline-block p-4 mb-6 -mt-16 bg-blue-400 rounded-full">
            <FaFire className="text-[38px] text-white" />
          </div>
          <h3 className="mb-4 text-2xl font-semibold">Rekindling Elegance</h3>
          <p className="text-base text-gray-500">
            ...
            diamonds, we aspire to bring back the allure and sophistication that
            these precious gems have always represented. We envision a future
            where the beauty of diamonds is once again celebrated and cherished.
          </p>
        </div>
      </div>
    </>
