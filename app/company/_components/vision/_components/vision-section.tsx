...
const VisionSectionOne = () => {
  const data: IServiceData[] = [
    ...
    },
    {
      ...
      desc: "Every Blue Spark Diamond adheres to ethical sourcing and, also stringent procedures. The diamonds proudly hold GIA Certification and Kimberly Process Certification, ensuring quality and responsibility.",
      title: "Our Values",
    },
    {
