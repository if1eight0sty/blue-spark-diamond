...
const FlagDropdown = dynamic(
  () => import("./_components/appbar/flag-dropdown"),
  {}
);
  ...
  return (
    <>
      <nav className="@container z-[1] top-0 sticky isolate">
        {/* head */}
        <div className="flex items-center flex-col justify-center  px-4 shadow-sm opacity-95 backdrop-blur-2xl bg-[#F7F6F3] z-[2]">
